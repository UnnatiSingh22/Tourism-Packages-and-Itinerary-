...
import { AmalfiDaySection, type AmalfiDay } from '../components/amalfi/AmalfiDaySection';
import { RouteOverviewCard } from '../components/amalfi/RouteOverviewCard';
import { ResourceStatusCard } from '../components/amalfi/ResourceStatusCard';
import { ConciergeCard } from '../components/amalfi/ConciergeCard';
...
export function AmalfiItineraryPage() {
  return (
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-[65%] xl:w-[70%]">
          {mockKeralaData.days.map((day) => (
            <AmalfiDaySection key={day.dayNumber} day={day as AmalfiDay} />
          ))}
        </div>
